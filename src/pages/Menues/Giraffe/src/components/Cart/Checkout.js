...
const Checkout = (props) => {
    ...
    return (
        <form class="form" onSubmit={confirmHandler}>
            <div class="control">
            ...
            <div class="control">
                ...
                {!formInputsValidity.name && <p class="errorMsg">Please enter a phone number</p>}
            </div>
            <div class="control">
                <label htmlFor='street'>Street</label>
                <input type='text' id='street' ref={streetInputRef} />
                {!formInputsValidity.name && <p class="errorMsg">Please enter a street address</p>}
            </div>
            <div class="control">
                <label htmlFor='postal'>Postal Code</label>
                <input type='text' id='postal' ref={postalInputRef} />
                {!formInputsValidity.name && <p class="errorMsg">Please enter a postal code</p>}
            </div>
            <div class="control">
                <label htmlFor='city'>City</label>
                <input type='text' id='city' ref={cityInputRef} />
                {!formInputsValidity.name && <p class="errorMsg">Please enter a city</p>}
            </div>
            <div class="actions">
